...
public function carrera()
{
    ...
    {
        return $this->select('a.clave as claveAsignatura, a.nombre as nombreAsignatura, programacion.*')->join('asignaturas as a', 'programacion.materia_id = a.id')->where('docente_id', $docente_id)->findAll();
    }
