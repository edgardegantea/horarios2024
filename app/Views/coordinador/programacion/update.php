...
<?= $this->section('content') ?>
    ...
    <form method="post" action="/coordinador/programacion/update/<?php echo $asignacion['id']; ?>">
        ...
        <div>
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="checkbox" name="nullify_dates" id="nullify_dates">
                    <label for="nullify_dates"><span class="text-danger">ANULAR FECHAS</span></label>
                </div>
            </div>
        </div>
