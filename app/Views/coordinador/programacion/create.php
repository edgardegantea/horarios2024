...
<form action="<?= base_url('coordinador/programacion/create/' . $carrera_id) ?>" method="post">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="docente" id="docente">
                <?php foreach ($docentes as $docente): ?>
                    <option class="text-uppercase" value="<?= $docente['id']; ?>"><?= '(' . $docente['username'] . ') '. $docente['nombre'] . ' ' . $docente['apaterno'] . ' ' . $docente['amaterno']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
        ...
        <td>
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="hora_inicio2">Inicia:</label>
                        <input type="time" name="hora_inicio3" id="hora_inicio3" value="<?= old('hora_inicio3'); ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="hora_fin2">Finaliza:</label>
                        <input type="time" name="hora_fin3" id="hora_fin3" value="<?= old('hora_fin3'); ?>">
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="hora_inicio2">Inicia:</label>
                        <input type="time" name="hora_inicio4" id="hora_inicio4" value="<?= old('hora_inicio4'); ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="hora_fin2">Finaliza:</label>
                        <input type="time" name="hora_fin4" id="hora_fin4" value="<?= old('hora_fin4'); ?>">
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="hora_inicio2">Inicia:</label>
                        <input type="time" name="hora_inicio5" id="hora_inicio5" value="<?= old('hora_inicio5'); ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="hora_fin2">Finaliza:</label>
                        <input type="time" name="hora_fin5" id="hora_fin5" value="<?= old('hora_fin5'); ?>">
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="hora_inicio2">Inicia:</label>
                        <input type="time" name="hora_inicio6" id="hora_inicio6" value="<?= old('hora_inicio6'); ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="hora_fin2">Finaliza:</label>
                        <input type="time" name="hora_fin6" id="hora_fin6" value="<?= old('hora_fin6'); ?>">
                    </div>
                </div>
            </div>
        </td>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="time" name="hora_inicio7" id="hora_inicio7" value="<?= old('hora_inicio7'); ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="hora_fin7">Finaliza:</label>
                        <input type="time" name="hora_fin7" id="hora_fin7" value="<?= old('hora_fin7'); ?>">
                    </div>
                </div>
            </div>
        </td>
